...
const Sidebar = ({ sidebarOpen, onCloseSidebar }: ISidebarProps) => {
  const { filterFormStore, filteredDbLength, searchMovieDb } = showroomStore;
  ...
  return (
    <div className={classes.sidebar} style={styleSidebar}>
      ...
      <div>
        <div className={classes.searchContainer}>
          <SearchBar
            ...
            searchMovie={(movieName, searchCategory) =>
              searchMovieDb(movieName, searchCategory)
            }
        ...
        <div className={classes.filterContainer}>
          <button
            ...
            className={!filterActive ? classes.btnActive : ""}
          >
            {filterActive ? "Filter deaktivieren" : "Filter sind deaktiviert"}
          </button>
          ...
          <div className={classes.filterSegmentContainer}>
            ...
            <div className={classes.fskIndicatorContainer}>
              <FskIndicator arrowPos={fskPosAge} saveFskPos={setFskPosAge} />
            </div>
          </div>
          ...
          <button
            ...
            className={filterActive ? classes.btnActive : ""}
          >
            {filterActive ? "Gefiltert" : "Filtern"}
          </button>

          <div className={classes.sidebarInfos}>
            <div>
              <b>{filteredDbLength}</b> Filme
            </div>
          </div>
        </div>
      </div>
