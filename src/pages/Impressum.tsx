    ...
    return (
        <section className={classes.impressumContainer}>
            ...
            <div className={classes.impressum}>
                ...
                <p>Bastian Harttung<br/>
                    Bahnhofstr. 9<br/>
                    91161 Hilpoltstein</p>

                <h2>Kontakt</h2>
                <p>Telefon: 016096250129<br/>
                    E-Mail: info@bastian-harttung.de</p>
                ...
                <p>Unser Angebot enthält Links zu externen Websites Dritter, auf deren Inhalte wir keinen Einfluss
                    haben. Deshalb
                    können
                    wir für diese fremden Inhalte auch keine Gewähr übernehmen. Für die Inhalte der verlinkten Seiten
                    ist stets der
