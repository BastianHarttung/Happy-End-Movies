...
const DetailsMovie = ({ movie, saveMovieToDb, saveSelectedPerson }) => {
   ...
   const [happyMovie, setHappyMovie] = useState(
      movie.has_happy_end === true
         ? true
         : movie.has_happy_end === false
         ? false
         : "neutral"
   );
            ...
            <div className={classes.actorSearchContainer}>
               ...
               <div className={classes.searchContainer}>
                  ...
                  <div className={classes.lengthActors}>
                     (Gesamt: {movie.cast.length} Schauspieler)
                  </div>
               </div>
         ...
         <section className={classes.extraInfosSection}>
            <div className={classes.videosImagesContainer}>
               <div>
                  ...
                  {!!movie.images.logos.length && (
                     <ImagesBox title={"Logos"} images={movie.images.logos} />
                  )}
               </div>
            ...
            {movie.overview && (
               <div className={classes.description}>
                  <b>Beschreibung:</b> {movie.overview}
               </div>
            )}
         </section>
