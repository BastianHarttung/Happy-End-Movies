      ...
      <section className={classes.detailsMovieSection}>
         ...
         <div className={classes.movieInfosContainer}>
            ...
            <p className={classes.releaseYear}>
               ...
               {props.movie.last_air_date?.slice(0, 4)}
            </p>

            <p>
               Folge: ca. {props.movie.episode_run_time[0]} min
         ...
         <div className={classes.movieSection}>
            ...
            <div className={classes.detailsContainer}>
               <div>
                  ...
                  <div>Staffeln: {props.movie.number_of_seasons}</div>

                  <div>Folgen: {props.movie.number_of_episodes}</div>

                  <h5 className={classes.director}>
                     {props.movie.directors.length > 0 ? "Regie" : ""}
                  </h5>
                  <div className={classes.directorsContainer}>
                     {props.movie.directors.map((director, index) => (
                        <PersonBox
                           saveSelectedPerson={(person) =>
                              props.saveSelectedPerson(person)
                           }
                           person={director}
                           key={index}
                        />
            ...
            <div className={classes.actorSearchContainer}>
               ...
               <div className={classes.searchContainer}>
                  ...
                  <div className={classes.lengthActors}>
                     (Gesamt: {props.movie.cast.length} Schauspieler)
                  </div>
               </div>
         ...
         <section className={classes.extraInfosSection}>
            <div className={classes.videosImagesContainer}>
               <div>
                  {props.movie.images.posters.map((poster, index) => {
                     return (
                        <a
                           href={imageUrl + poster.file_path}
                           key={index}
                           target="_blank"
                           rel="noreferrer"
                        >
                  ...
                  {props.movie.images.backdrops.map((backdrop, index) => {
                     return (
                        <a
                           key={index}
                           href={imageUrl + backdrop.file_path}
                           target="_blank"
                           rel="noreferrer"
                        >
                           <img
            ...
            <div className={classes.description}>
               <b>Beschreibung:</b> {props.movie.overview}
            </div>
         </section>
               ...
               <div className={classes.smileys}>
                  <div>
                     ...
                     <FaMeh
                        ...
                        className={
                           props.movie.happyEnd_Voting &&
                           props.movie.happyEnd_Voting[user.userId] ===
                              "neutral"
