...
const Showroom = ({saveSelectedMovie}: IShowroomProps) => {
  ...
  const pages: number = Math.ceil(filterLength / pageLength);
   ...
   */
  function filterMoviesByName(movieName: string, searchCategory: TCategorySearch) {
   ...
   */
  function filterDatabase(movies, category: TCategoryFilter, happyEnd: THappyEndFilter, fskPosAge: number) {
   ...
   */
  function filterMoviesByCategory(movies, category: TCategoryFilter) {
   ...
   * @return {array} filtered movies
   */
  function filterMoviesByHappyEnd(movies, hasHappyEnd: boolean) {
   ...
   */
  function filterMoviesByFsk(movies, fskPosAge: number) {
    if (fskPosAge < 18) {
   ...
   * @return        {        Promise < void >    }
   */
  function searchMovieDb(movieName: string, searchCategory: TCategorySearch) {
